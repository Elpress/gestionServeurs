                ...
                <div class="card-body">
                    <table class="table table-bordered table-striped">
                        <tr>
                            ...
                            <th>Adrip du Serveur</th>
                            <th>Local</th>
                            <th>Action</th>
                            <th>Action</th>
                        </tr>
                        <c:forEach items="${serveurs}" var="L">
                            <tr>
                                <td>${L.idS}</td>
                                <td>${L.nomS}</td>
                                <td>${L.adripS}</td>
                                <td>${L.local.idL}</td>
                                <td><a class="btn btn-success" href="edit.jsp?idS=${L.idS}">Editer</a></td>
                                <td><a class="btn btn-danger" href="delete.jsp?idS=${L.idS}">Supprimer</a></td>
                            </tr>
                        </c:forEach>
                    </table>
                </div>
